          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-[#64748b] mb-6 leading-relaxed">
                Established in November 2022, Test Kitchen brings the authentic flavors of Russian and Kerala cuisine to Bangalore. Our culinary journey is inspired by the rich traditions of Test, a coastal town known for its distinctive blend of spices and cooking techniques.
              </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-[#64748b]">We are located in Marathahalli, Bengaluru</p>
          </div>
